...
void main() {
	...
	inout_buffer.data[global_index].c = vec4(1.0, 0.0, 1.0, 1.0);
        ...
        auto buf = Ren::Buffer{"buf", Ren::eBufType::VertexAttribs, Ren::eBufAccessType::Draw,
                               Ren::eBufAccessFreq::Static, sizeof(AttribData) * 128};
        ...
        auto stage_buf = Ren::Buffer{"stage_buf", Ren::eBufType::Stage, Ren::eBufAccessType::Copy,
                                     Ren::eBufAccessFreq::Stream, sizeof(AttribData) * 128};
        ...
        const uint32_t offset = buf.AllocRegion(128 * sizeof(AttribData), "test", &stage_buf);
        require(offset == 0);
