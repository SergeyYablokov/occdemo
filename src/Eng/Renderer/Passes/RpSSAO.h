...
class RpSSAO : public RenderPassBase {
    ...
    Ren::ProgramRef blit_ao_prog_, blit_bilateral_prog_, blit_upscale_prog_, blit_upscale_ms_prog_;
    ...
    void LazyInit(Ren::Context &ctx, ShaderLoader &sh, RpAllocTex &ssao1_tex, RpAllocTex &ssao2_tex,
  ...
  public:
    ...
    void Setup(RpBuilder &builder, const ViewState *view_state, int orphan_index, Ren::TexHandle rand2d_dirs_4x4_tex,
